...
HOST = "127.0.0.1"
PORT = 2000  # UDP port for GNU Radio

CHUNK_SIZE = 8192  # UDP-safe chunk size (8 KB per packet)

GUARD_BITS = [0] * 8
SLOTS_PER_FRAME = 8
MULTIFRAME_LENGTH = 51

# ---- REPEAT_MULTIFRAMES for ~30 seconds ----
# 1 multiframe ≈ 0.235 s, so 128 multiframes ≈ 30.1 s
REPEAT_MULTIFRAMES = 128  
...
# ============================================================
# BCCH BUILDER (simplified placeholder for now)
# ============================================================
...
def main():
    print("v16a running — UDP streaming, ~30s multiframe chunks with safe chunking")
