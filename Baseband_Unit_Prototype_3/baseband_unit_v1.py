...
from gnuradio.gsm import gsm_gmsk_mod
import sip
import threading



class baseband_unit_v1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "baseband_unit_v1")
        ...
        # Variables
        ##################################################
        self.samp_rate = samp_rate = 1.08333e6
        ...
        self.connect((self.digital_diff_encoder_bb_0, 0), (self.gsm_gmsk_mod_0, 0))
        self.connect((self.gsm_gmsk_mod_0, 0), (self.blocks_throttle2_0, 0))
...
def main(top_block_cls=baseband_unit_v1, options=None):
