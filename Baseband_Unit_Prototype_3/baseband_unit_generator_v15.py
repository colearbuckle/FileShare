...
REPEAT_MULTIFRAMES = 20  # pre-generate multiple for continuous streaming
...
# ============================================================
# BCCH BUILDER (simplified for now)
# ============================================================
...
def main():
    print("v15 running — UDP streaming with repeating multiframes")
